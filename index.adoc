...
* link:presentation.html[Self-Study Flashcards]
* Midterm II: 80 minutes, closed book, one written cheat sheet, in-class. link:studyguide2.html[Study Guide]
* link:assts/project.html[Project: File system]: **Due Sunday May 3** No extensions
* Resubmitted work: **Due Sunday May 3** Please send one email or slack to list all requests for regrades
