...
In the file, `shell02.c`, extend the features of your shell from link:asst02.html[Assignment 02]. 
...
NOTE: Best practice is to always check the return value of any system calls you make
