...
Refactor your shell to use your new functions. You now have code to implement `ls`, `cat`, and `touch`.
...
Be systematic with your implementation. You should be aware of which features have been implemented and which haven't. You should also be aware of the limitations in your current implementation.
