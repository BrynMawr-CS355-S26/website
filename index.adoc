...
* link:labs/lab07.html[Lab April 2: Inode your busy]: ** Due Tuesday April 7**, No extensions
* link:labs/lab08.html[Lab April 9: File system design]: **Handout Due Thursday End-of lab, April 9** No extensions
* link:labs/project.html[Project: File system]: **Due Sunday May 3** No extensions
* Resubmitted work: **Due Sunday May 3** Please send one email or slack to list any requests for regrades
...
| Lecture | Park 336 | Tuesday and Thursday 11:40 PM - 1:00 PM 
...
* (Optional) link:https://diveintosystems.org/[Dive Intro Systems] by Matthews, Newhall, and Webb
* (Optional) link:https://www.amazon.com/More-Effective-Improve-Programs-Designs/dp/020163371X[More Effective C++: 35 New Ways to Improve Your Programs and Designs] by Scott Meyers
