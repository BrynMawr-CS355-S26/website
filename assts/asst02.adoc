...
* When the user gives a command, split it into a command and arguments so you can call link:https://www.man7.org/linux/man-pages/man3/exec.3.html[execvp] after creating a new process with fork.
